...
Task.create!([
  { label: Faker::TvShows::TwinPeaks.quote, user: user, order: order_sequence.pop, state: 'started', started_at: Time.current },
  { label: Faker::TvShows::TwinPeaks.quote, user: user, order: order_sequence.pop, state: 'started', started_at: Time.current },
  { label: Faker::TvShows::TwinPeaks.quote, user: user, order: order_sequence.pop, state: 'started', started_at: Time.current },
  { label: Faker::TvShows::TwinPeaks.quote, user: user, order: order_sequence.pop, state: 'started', started_at: Time.current },
  { label: Faker::TvShows::TwinPeaks.quote, user: user, order: order_sequence.pop, state: 'started', started_at: Time.current },
  ...
  { label: Faker::TvShows::TwinPeaks.quote, user: user, order: order_sequence.pop, state: 'planned', started_at: Time.current, planned_at: 1.day.ago },
  { label: Faker::TvShows::TwinPeaks.quote, user: user, order: order_sequence.pop, state: 'planned', started_at: Time.current, planned_at: 2.days.ago },
